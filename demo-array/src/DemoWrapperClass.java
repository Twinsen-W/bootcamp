public class DemoWrapperClass {
  public static void main(String[] args) {
    ...
    // ! Wrapper Class (More functinalities)
    // ! Primitive ( For storing value, comparsion, basic Math operation)

    // Define Wrapper Class
    System.out.println(Integer.valueOf(3));
    System.out.println(Long.valueOf(3)); // int-> long
    System.out.println(Character.valueOf('a')); // int -> long
    System.out.println(Boolean.valueOf(true)); // int -> long
   ...
   Integer x4 = (int) 4L; // long -> int (downcast) -> Integer (auto-box)
    ...
    // ! Wrapper Class comparsion (use method ONLY, compareTo)
    Integer i1 = 10;
    Integer i2 = 11;
    ...
    // ! i3 is a Primitive, which has NO functionailtiy
    ...
    // Character (ASCII)
    Character ch3 = 'b';
    System.out.println(ch3.charValue() > 97);
