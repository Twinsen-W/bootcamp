...
public class LoopExercise {
  public static void main(String[] args) {
    ...
    System.out.println("The sum of the numbers between 0 and 15 is " + sum);
  ...
  int evenSum = 0 ;
      ...
      if (i % 2 == 0) {
       ...
       System.out.println("The product of oddsum and evensum is " + product);
 ...
 String str7 = "ijkabcpodi";
    ...
    // Use: for loop + if + substring method
     String s8a = "abcba";
    String s8b = "cba";
    for (int i = 0; i < s8a.length(); i++) { // length()
      for (int j = 0; ; j++) {
        for (int k = 0; ; k++) {             
    
    if (s8a.charAt(i) == s8b.charAt(i) && (s8a.charAt(j + 1) == s8b.charAt(j + 1)) && (s8a.charAt(k + 2) == s8b.charAt(k + 2))) {
    ...
    System.out.println("count uppercase=" + counter2);
